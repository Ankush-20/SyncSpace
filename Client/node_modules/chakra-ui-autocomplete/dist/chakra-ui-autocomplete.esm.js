...
import { Stack, Box, List, ListItem, ListIcon, Text } from '@chakra-ui/layout';
...
function defaultCreateItemRenderer(value) {
  return createElement(Text, null, createElement(Box, {
    as: 'span'
...
var CUIAutoComplete = function CUIAutoComplete(props) {
  ...
  return createElement(Stack, null, createElement(FormLabel, Object.assign({}, _extends({}, getLabelProps({}), labelStyleProps)), label), selectedItems && createElement(Stack, {
    spacing: 2,
    isInline: true,
    flexWrap: 'wrap'
  ...
  })) : createElement(Fragment, null, createElement(Input, Object.assign({}, inputStyleProps, getInputProps(getDropdownProps({
    placeholder: placeholder,
    onClick: isOpen ? function () {} : openMenu,
    onFocus: isOpen ? function () {} : openMenu,
    ref: disclosureRef
  })))), !hideToggleButton && createElement(Button, Object.assign({}, toggleButtonStyleProps, getToggleButtonProps(), {
    "aria-label": 'toggle menu'
  }), createElement(ArrowDownIcon, null)))), createElement(Box, {
    pb: 4,
    mb: 4
    ...
    return createElement(ListItem, Object.assign({
      ...
      item: item,
      index: index
    })), isCreating ? createItemRenderer(item.label) : createElement(Box, {
      display: 'inline-flex',
      alignItems: 'center'
    }, selectedItemValues.includes(item.value) && createElement(ListIcon, Object.assign({
